...
namespace AutoLevelup
{
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            {
                Menu.AddItem(new MenuItem("Enabled", "Enabled").SetValue(new KeyBind(36, KeyBindType.Press)));
            }
            Menu.AddToMainMenu();
            ...
            Game.PrintChat("Make sure to Enable AutoLevelUP from Menu!");
        ...
        private static void Game_OnGameUpdate(EventArgs args)
        {
            ...
            var enabled = Menu.Item("Enabled").GetValue<KeyBind>().Active;
